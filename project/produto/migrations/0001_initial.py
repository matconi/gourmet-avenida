    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(max_length=80, verbose_name='Link')),
                ('supercategory', models.ForeignKey(blank=True, db_column='supercategory_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='produto.category', verbose_name='Subcategoria de ')),
            ],
            options={
