...
class Order(models.Model):
    ...
    total_price = models.DecimalField("Preço Total", max_digits=5, decimal_places=2, blank=True)
    total_quantity = models.PositiveIntegerField("Quantidade Total", blank=True)
